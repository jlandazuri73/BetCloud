...
export default function Layout({ children, vip }) {
  ...
  function getClass() {
    return {
      vip: vip ? "bg-white text-black " : "text-gray-500 ",
      free: !vip ? "bg-white text-black " : "text-gray-500 ",
    };
  }
                                        ...
                                        <Link to={"/"}>
                                          ...
                                          >
                                            <div
                                              className={
                                                getClass().free +
                                                "group/button relative flex w-full items-center justify-center gap-1 rounded-lg border py-3 outline-none transition-opacity duration-100 sm:w-auto sm:min-w-[148px] md:gap-2 md:py-2.5 border-black/10  shadow-[0_1px_7px_0px_rgba(0,0,0,0.06)] hover:!opacity-100"
                                              }
                                            >
                                        ...
                                        <Link to={"/vip/"}>
                                          ...
                                          >
                                            <div
                                              className={
                                                getClass().vip +
                                                "font-semibold group/button relative flex w-full items-center justify-center gap-1 rounded-lg border py-3 outline-none transition-opacity duration-100 sm:w-auto sm:min-w-[148px] md:gap-2 md:py-2.5 border-transparent"
                                              }
                                            >
                                              <span className="truncate text-sm font-medium md:pr-1.5">
                                                VERSION VIP
