...
function PronosticoItem() {
  return (
    <div className="pronostico w-full h-24 rounded mb-7">
      ...
      <div className="body-pronostico relative text-center rounded flex justify-between items-center w-full">
        ...
        <div className="flex">
          ...
          <div className="px-1 text-sm">
            {/*Esperar <i class="fa-regular fa-clock text-yellow-300"></i>*/}
            {/*Ganada <i class="fa-solid fa-square-check text-green-300"></i>*/}
